...
class PassStrengthChecker extends StatefulWidget {
  const PassStrengthChecker({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _PassStrengthCheckerState createState() => _PassStrengthCheckerState();
}

class _PassStrengthCheckerState extends State<PassStrengthChecker> {
